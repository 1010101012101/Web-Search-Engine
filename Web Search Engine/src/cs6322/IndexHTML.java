package cs6322;
import CSE494.CSE494Analyser;
import CSE494.HTMLDocument;
...
// "C:\\Users\\Sahil\\Desktop\\ResultSet1"
...
public class IndexHTML 
{
	...
	/** Usage : java IndexHTML [-create] [-index <index>] <root_directory> */
	public static void main(String[] argv) {
		try {
			...
			System.err.println("length: " + argv.length);
			if (argv.length == 0) {
			...
			writer = new IndexWriter(index, new CSE494Analyser(), create);
